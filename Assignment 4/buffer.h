...
class Buffer {
private:
  // vector holds the items
  vector<buffer_item> daBuffer;
  //for current size, in and out for inserting/removing and bufferSize to initialize the vector
  int count, in, out, bufferSize;
