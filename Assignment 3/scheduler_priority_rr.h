...
private:
  ...
  vector<PCB> processes; //list of PCBs
  unsigned int avgTA; //contains average turn-around times
  unsigned int avgWT; //conains average waiting times
  unsigned int time; //current time
  unsigned int count; //num of processeses
  unsigned int q; //quantum time
